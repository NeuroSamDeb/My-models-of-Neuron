...
Original file is located at
    https://colab.research.google.com/drive/1xbAbzEXxZVNbWvIkgryLhXCYrT6c11Wi
...
As is seen, there is not much difference in the graphs between the euler method and the RK4 method. Future work for me would be to analyse methods for better precision results.
"""