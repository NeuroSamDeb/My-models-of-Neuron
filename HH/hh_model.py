...
I_end_idx = int(11 / dt)
I_app_trace[I_start_idx:I_end_idx] = 10.0 # uA/cm^2
...
"""At the end, due to the nature of the hodgkin huxley equations being interdependent on each other, Euler method is a first approximation of the simulation. I am going to try out other more advanced methods in my future tries."""